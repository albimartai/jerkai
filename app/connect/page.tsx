...
import { CATEGORIES, SOURCE_METADATA, type DataSource } from "@/app/connect/source-metadata";
...
// the LocalTime nodes nested inside it — is inlined into Connect()'s own
// top-level tree rather than left as an unresolved SourceCard element node.
// Integration tests (tests/integration/connect.test.ts, AC-ST2/AC-ST3) inspect
